  ...
  <div class="container">
    ...
    <form action="add" method="post" class="needs-validation" novalidate>
      ...
      <div class="form-group px-3 py-3" style="text-align: right;">
           <button class="btn btn-primary" type="submit"> <i class='fa fa-plus-circle' style='color: blue'></i> GUARDAR </button>
           <button class="btn btn-primary" type="button" onclick="window.location.href='/ismac-libreria-web-online/libros/findAll'; return false;"><i class='fa fa-times-circle' style='color: red'></i> CANCELAR </button>     
      </div>
